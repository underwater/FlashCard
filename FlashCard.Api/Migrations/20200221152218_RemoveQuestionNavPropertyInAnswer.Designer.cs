...
namespace FlashCard.Api.Migrations
{
    ...
    [Migration("20200221152218_RemoveQuestionNavPropertyInAnswer")]
    partial class RemoveQuestionNavPropertyInAnswer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlashCard.Api.Models.QuizQuestion", b =>
                {
            ...
            modelBuilder.Entity("FlashCard.Api.Models.QuizQuestion", b =>
                {
                    b.HasOne("FlashCard.Api.Models.Quiz", "Quiz")
                        .WithMany("Questions")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FlashCard.Api.Models.Question", "Questions")
                        .WithMany()
